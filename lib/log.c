...
void LOG(int fd, int level, const char* fmt, ...) 
{
	...
	l = snprintf(buf, MAX_LOG_LEN - 1, "\033[%s\033[1m[%s]:[%04d-%02d-%02d %02d:%02d:%02d]", color, slog, tmm.tm_year + 1900, tmm.tm_mon + 1, tmm.tm_mday, tmm.tm_hour, tmm.tm_min, tmm.tm_sec);
